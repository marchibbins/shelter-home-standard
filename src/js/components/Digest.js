                            ...
                            <Tab.Pane eventKey="1" className="dimension-digest__panel">
                                <Collapse in={this.state[1]}>
                                    <div>
                                        ...
                                        <p><Link to="/foreword-campbell-ross" className="read-more">Read more</Link></p>
                                    </div>
                                </Collapse>
                            </Tab.Pane>
                            ...
                            <Tab.Pane eventKey="2" className="dimension-digest__panel">
                                <Collapse in={this.state[2]}>
                                    <div>
                                        ...
                                        <p><Link to="/foreword-british-gas" className="read-more">Read more</Link></p>
                                    </div>
                                </Collapse>
                            </Tab.Pane>
                            ...
                            <Tab.Pane eventKey="3" className="dimension-digest__panel">
                                <Collapse in={this.state[3]}>
                                    <div>
                                        ...
                                        <p><Link to="/foreword-ipsos-mori" className="read-more">Read more</Link></p>
                                    </div>
                                </Collapse>
                            </Tab.Pane>
                        </Tab.Content>
